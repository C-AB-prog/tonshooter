 ...
 */
export function zoneCenterAt(elapsedMs, zoneWidth, speed, phase) {
 ...
 */
export function difficultyToParams(difficulty) {
 ...
 */
export function positionAt(elapsedMs, speed) {
    const t = elapsedMs / 1000;
    const x = t * speed;
    return pingPong01(x);
}
export function isHit(pos, zoneCenter, zoneWidth) {
